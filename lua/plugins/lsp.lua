...
lsp.extend_lspconfig({
  ...
  lsp_attach = function(_, bufnr)
    ...
    map("n", "ws", function() vim.lsp.buf.workspace_symbol() end, opts)
    ...
    map("n", "ca", function() vim.lsp.buf.code_action() end, opts)
    map("n", "rr", function() vim.lsp.buf.references() end, opts)
    map("n", "rn", function() vim.lsp.buf.rename() end, opts)
